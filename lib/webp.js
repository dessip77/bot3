  ...
  static muxAnim({
    ...
    return _asyncToGenerator(function* () {
      ...
      if (frames.length == 0) {
        ...
        throw new Error("X fora de alcance");
      } else if (y < 0 || y >= 1 << 24) {
...
var _readHeader2 = /*#__PURE__*/ (function () {
  var _readHeader3 = _asyncToGenerator(function* (fd) {
    ...
    if (buf.toString("utf8", 0, 4) != "RIFF") {
      throw new Error("Cabeçalho incorreto (não RIFF)");
    }

    if (buf.toString("utf8", 8, 12) != "WEBP") {
      throw new Error("Cabeçalho incorreto (não WEBP)");
    }
...
var _readChunk_VP8L_buf2 = function _readChunk_VP8L_buf2(buf, size, cursor) {
  if (cursor >= buf.length) {
    throw new Error("Atingido o final do buffer durante a leitura do bloco VP8L");
  }
...
var _readChunk_ANIM2 = /*#__PURE__*/ (function () {
  var _readChunk_ANIM3 = _asyncToGenerator(function* (fd, size) {
    ...
    if (bytesRead != size) {
      throw new Error("Fim do arquivo alcançado durante a leitura do trecho ANIM");
    }
